...
#define CALIBRATION_DAC_SETTLE_TIME 1       // how long in ticks the task should delay to let the DAC settle (before sampling the frequency again)
...
#define MAX_FREQ_SAMPLES 20                // how many frequency calculations we want to use to obtain our average frequency prediction of the input. The higher the number, the more accurate the result
