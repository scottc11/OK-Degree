...
#define FLASH_SEQUENCE_CONFIG_ADDR (uint32_t)0x080605e0
#define FLASH_SEQUENCE_DATA_ADDR (uint32_t)0x08060600
#define FLASH_CHANNEL_CONFIG_ADDR (uint32_t)0x080605c0
