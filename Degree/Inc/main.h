...
#define CALIBRATION_ARR_SIZE (SETTINGS_BENDER_MAX + 1)
...
#define SETTINGS_PLAYBACK_MODE_INDEX 0
#define SETTINGS_BENDER_MIN_INDEX 1
#define SETTINGS_BENDER_MAX_INDEX 2
#define SETTINGS_BENDER_MODE_INDEX 3
#define SETTINGS_PITCH_BEND_RANGE_INDEX 4
